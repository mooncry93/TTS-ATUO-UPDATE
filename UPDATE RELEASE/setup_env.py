...
MODELS_TO_DOWNLOAD = [
    ...
    # OmniVoice GGUF models
    {
        "name": "OmniVoice GGUF",
        "url": "https://huggingface.co/Serveurperso/OmniVoice-GGUF/resolve/main/omnivoice-base-Q8_0.gguf",
        "dest": "models/omnivoice/omnivoice-base-Q8_0.gguf"
    },
    {
        "name": "Fish Speech Tokenizer",
        "url": "https://huggingface.co/Serveurperso/OmniVoice-GGUF/resolve/main/omnivoice-tokenizer-Q8_0.gguf",
        "dest": "models/fish_speech/omnivoice-tokenizer-Q8_0.gguf"
    }
]
...
def install_dependencies():
    packages = ["fastapi", "uvicorn", "requests", "gtts", "soundfile", "numpy", "torch", "librosa", "pyttsx3"]
    total = len(packages)
